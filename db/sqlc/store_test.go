...
func TestTransferTx(t *testing.T) {
	...
	amountMinusDecimal, _ := decimal.NewFromString("-" + amount)
	...
	for i := 0; i < n; i++ {
		...
		require.True(t, transfer.Amount.Equal(amountDecimal))
		...
		require.True(t, fromEntry.Amount.Equal(amountMinusDecimal))
		...
		require.True(t, toEntry.Amount.Equal(amountDecimal))
